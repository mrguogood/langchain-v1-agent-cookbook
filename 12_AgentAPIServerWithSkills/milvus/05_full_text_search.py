...
# text = "入职不到30天，OpenAI员工闪辞Meta回归，赵也反悔过"
# result = client.run_analyzer(
#     text,
#     analyzer_params
# )
...
retrieved_lines_with_distances = [
    (res["highlight"]["title"], res["entity"]["title"], res["entity"]["content_chunk"], res["entity"]["link"], res["entity"]["pubAuthor"], res["distance"]) for res in res[0]
]
