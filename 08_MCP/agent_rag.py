...
async def main():
    ...
    async with AsyncConnectionPool(
        ...
        # 写入长期记忆
        await write_long_term_info("user_005", "gcs")
        ...
        # 定义原始用户问题
        # raw_question = "我这边今天天气怎么样？"
        raw_question = "张三九的基本信息？"
        # 获取长期记忆内容，用户偏好设置(用户名称)
        name = await read_long_term_info("user_005")
        ...
        response = await run_with_hitl_invoke(
            ...
            config=config,
            context=Context(user_id="user_005")
        )
